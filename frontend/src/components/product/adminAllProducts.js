...
import { deleteProductById, getAllProduct } from '../../api/api'
...
const AdminAllProducts = () => {
    ...
    <div className="card p-4" id="cards">
      ...
      <div className="row mt-4">
        ...
        <div className="col-md-7">
            ...
            <p className="text-muted mt-4">RS {props.product.price}</p>                
            </div>
  ...
  const callDelete=(props)=>{
    ...
    deleteProductById(props.product.productId).then((res)=>{
