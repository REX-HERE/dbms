...
const SellingProducts = () => {
    return (
        <div>
          ...
          <br />
          <br />
          <div><button style={{marginLeft: '24%'}} type="button" className="btn btn-primary btn-lg ">Add New Product</button>
            <button style={{marginLeft: '5%'}} type="button" className="btn btn-primary btn-lg ">Go To Profile</button>
          </div>
          <br />
          <br />
